      ...
      <Collapse in={expanded}>
        <Box sx={{ px: 2, pb: 2, display: 'flex', flexDirection: 'column', gap: 0.5 }}>
          <Typography variant="body2">
            <strong>Number of annotations:</strong> {summary.n_annotations}
          </Typography>
          <Typography variant="body2">
            <strong>Number of images:</strong> {summary.n_images}
          </Typography>
          <Typography variant="body2">
            <strong>Number of annotation sets:</strong> {summary.n_annotation_sets}
          </Typography>
          <Typography variant="body2">
            <strong>Number of image sets:</strong> {summary.n_image_sets}
          </Typography>
        </Box>
      </Collapse>
    </Box>
